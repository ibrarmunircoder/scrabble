...
7.Let's test this function! Create a variable called brownie_points and set it equal to the value returned by the score_words() function with an input of "BROWNIE".
